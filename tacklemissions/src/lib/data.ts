...
export const teamMembers = [
  {
    ...
    bio: "Undergraduate researcher focused on nanoparticle synthesis, surface-display engineering, and synthetic biology platform development.",
  ...
  },
  {
    ...
    affiliation: "University of Queensland",
    bio: "Undergraduate researcher specialising in enzyme engineering, protein surface-display systems, and archaea biology.",
    category: "Undergraduate",
    initials: "TM",
    color: "#3B82F6",
