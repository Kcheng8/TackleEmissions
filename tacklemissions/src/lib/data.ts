...
export const teamMembers = [
  {
    ...
    bio: "Chemical & Biological Engineering student. Focused on PHA nanoparticle synthesis, surface-display engineering, and synthetic biology platform development.",
    category: "Undergraduate",
    initials: "KC",
    color: "#00C16E",
    expertise: ["Synthetic Biology", "Process Engineering", "Bionanotechnology"],
  },
  {
    name: "Research Team",
    role: "Molecular Biology",
    affiliation: "University of Queensland",
    bio: "Enzyme engineering, protein surface-display systems, and archaea biology. Responsible for PeiR cloning, expression optimisation, and activity assays.",
    category: "Undergraduate",
    initials: "ML",
    color: "#3B82F6",
    expertise: ["Molecular Biology", "Enzyme Engineering", "Microbiology"],
  },
  {
    name: "Research Team",
    role: "Bioinformatics & Modelling",
    affiliation: "University of Queensland",
    bio: "Computational modelling of enzyme–substrate interactions, nanoparticle behaviour in rumen conditions, and molecular docking studies.",
    category: "Masters",
    initials: "BM",
    color: "#8B5CF6",
