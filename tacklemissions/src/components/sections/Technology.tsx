  ...
  return (
    <SectionWrapper id="technology" className="py-24 bg-[#030D14] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          {...fadeUp(0.1)}
          className="rounded-2xl p-8 border border-white/5 bg-gradient-to-b from-white/[0.02] to-transparent mb-16"
        >
          <h3 className="text-white font-bold text-xl mb-6 text-center">Platform Architecture</h3>
          <div className="relative flex flex-col items-center gap-0">
            {/* Rows */}
            <div className="flex items-center gap-4 mb-4">
              <div className="glass rounded-xl px-6 py-3 text-sm font-semibold text-[#00C16E] border border-[#00C16E]/20">
                Microbial Fermentation
              </div>
              <span className="text-gray-600">→</span>
              <div className="glass rounded-xl px-6 py-3 text-sm font-semibold text-[#3B82F6] border border-[#3B82F6]/20">
                PHA Biosynthesis
              </div>
              <span className="text-gray-600">→</span>
              <div className="glass rounded-xl px-6 py-3 text-sm font-semibold text-[#8B5CF6] border border-[#8B5CF6]/20">
                Nanoparticle Formulation
              </div>
            </div>
            <div className="w-0.5 h-6 bg-white/10" />
            <div className="flex items-center gap-4 mb-4">
              <div className="glass rounded-xl px-6 py-3 text-sm font-semibold text-[#F59E0B] border border-[#F59E0B]/20">
              ...
              <span className="text-gray-600">→</span>
              <div className="glass rounded-xl px-6 py-3 text-sm font-semibold text-white border border-white/10">
                Armed Nanoparticle
              </div>
            </div>
            <div className="w-0.5 h-6 bg-white/10" />
